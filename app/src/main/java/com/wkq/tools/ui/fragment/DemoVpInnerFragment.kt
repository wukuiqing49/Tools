 ...
 *@Desc:
 */
class DemoVpInnerFragment:Fragment () {
    private lateinit var binding: FragmentVpDemoBinding

    companion object{
        fun newInstance(content:String): DemoVpInnerFragment{
            val args = Bundle()

            val fragment = DemoVpInnerFragment()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentList.add(DemoFragment.newInstance("Fragment内部1"))
        fragmentList.add(DemoFragment.newInstance("Fragment内部2"))
        fragmentList.add(DemoFragment.newInstance("Fragment内部3"))
        tableList.add("第一")
        tableList.add("第二")
        tableList.add("第三")
